...
Read `AGENTS.md`, `CLAUDE.md`, `docs/architecture.md`, and `CONTRIBUTING.md` first. Trace one supplied behavior from UI entry through Solid components, Zustand state, IRC/wire, persistence, and tests. Do not edit, commit, deploy, change dependencies, write `out/`, or touch `/home/kain/onyx-server`.
