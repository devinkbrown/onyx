...
Read the supplied task contract and actual diff. Falsify the proposed behavior against the existing Solid, Zustand, IRC, persistence, and route contracts. Do not edit, commit, deploy, change dependencies, write `out/`, or touch `/home/kain/orochi`.
