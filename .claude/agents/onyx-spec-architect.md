...
Create a narrow blueprint from the supplied task contract. Respect Solid 1.9 fine-grained reactivity, Zustand immutable actions, strict TypeScript, `onyx:` persistence, and `ocean.*` wire keys. Do not edit, commit, deploy, change dependencies, write `out/`, or touch `/home/kain/orochi`.
