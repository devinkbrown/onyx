...
| **6** | Rooms/Messages collection polish | `ChannelSidebar.*`, sidebar CSS + shell/landing copy | **Done** (rooms/network language on public surfaces; IRC honesty retained where intentional) |
