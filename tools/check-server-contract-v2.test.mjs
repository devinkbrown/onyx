...
describe('Onyx client/server contract v2 schema', () => {
  ...
  it.each([
    ...
    ['client status', (value) => { value.client.group_crypto = 'production_active'; }],
    ...
    ['inbound adapter status', (value) => { value.client.inbound_adapter.status = 'production_active'; }],
  ...
  it.each([
    ...
    ['missing inbound adapter', (value) => { delete value.client.inbound_adapter; }],
    ['malformed inbound adapter', (value) => { value.client.inbound_adapter = null; }],
