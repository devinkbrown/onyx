...
const phases: Phase[] = [
  ...
  },
  {
    ...
    state: 'active',
    date: '2026-07-09',
    summary: 'Generalize offline-first behavior into read, compose, search, PWA install clarity, moderation drafts, desktop packaging, installed-app readiness, update recovery, and portable local-state/account handoff transfer.',
