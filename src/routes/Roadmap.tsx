...
const phases: Phase[] = [
  ...
  },
  {
    ...
    items: ['TravelTo vault fallback', 'Active-target vault search', 'Immediate vault-result navigation', 'Offline reviewed recall', 'Offline search gating', 'Installable manifest', 'PWA shortcuts', 'Portable vault export', 'Portable vault import', 'Reviewed catch-up transfer', 'Room draft transfer', 'Full offline-first UX', 'Desktop packaging path'],
  },
];
