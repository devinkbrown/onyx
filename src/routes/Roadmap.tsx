      ...
      <section class="r-wrap r-section data-grid" aria-label="Roadmap next steps">
        <article class="data-card">
          ...
          <p>
            ...
            reader transcript jumps, digest review handoff, review completion, reader return-home affordances, reviewed-span recall, hydrated context trails, and
        ...
        <aside class="data-card">
          ...
          <div class="data-list data-list--compact">
            ...
            <div class="data-row"><div><strong>Reader mode</strong><span>Extend reviewed-span trails into local-vault context when neighboring lines are not hydrated.</span></div></div>
