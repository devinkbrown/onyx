...
const phases: Phase[] = [
  ...
  },
  {
    ...
    items: ['Block-Kit-lite renderer', 'Block-Kit-lite message controls', 'Client extension surface', 'Capability-scoped extension actions', 'Importer path', 'Incoming webhook migration', 'Server snapshot imports', 'IRC-log-to-vault import', 'Bridge status surface', 'Integrations page'],
  },
  {
    phase: 'Phase 13',
