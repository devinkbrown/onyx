...
const phases: Phase[] = [
  ...
  },
  {
    ...
    items: ['Named conversations', 'Forum projection', 'Forum topic follow controls', 'Pinned forum projection', 'Calm notification presets', 'Compact calm preset control', 'Quiet boosts', 'Quiet boost Home digest', 'Presence-as-place header', 'One-canvas responsive projection', 'Mobile Home tab', 'Touch-sized Home review cards'],
  },
  {
    phase: 'Phase 10',
    title: 'Atmosphere',
