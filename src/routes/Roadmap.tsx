...
const phases: Phase[] = [
  ...
  },
  {
    ...
    state: 'active',
    date: '2026-07-09',
    summary: 'Home now brings followed activity, scheduled rooms, local memory, quiet rooms, return recaps, room rhythm, reader summaries, shareable moments, reader memory, search handoff, transcript jumps, and digest review completion into view.',
    items: ['Followed catch-up', 'Scheduled events on Home', 'Vault memory previews', 'Quiet room activity', 'Home return recaps', 'Spotlight handoff', 'Room rhythm heatlines', 'Event context', 'Reader digest notes', 'Shareable moment links', 'Reader memory context', 'Moment search handoff', 'Reader transcript jumps', 'Digest review handoff', 'Review completion'],
  },
  {
    phase: 'Phase 7',
    title: 'Washi',
      ...
      <section class="r-wrap r-section data-grid" aria-label="Roadmap next steps">
        <article class="data-card">
          ...
          <p>
            ...
            handoff, room rhythm heatlines, event context, reader digest notes,
            shareable moment links, reader memory context, moment search handoff,
