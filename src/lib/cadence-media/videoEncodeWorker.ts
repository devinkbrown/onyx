...
/**
 * Resolutions the cadencevis WASM encoder is known to accept, largest first. Used as
 * a fallback ladder: the codec rejects some sizes (notably ≥1600 wide and a few
 * small/odd ones), returning a null handle that makes CadenceVisEncoder throw. When
