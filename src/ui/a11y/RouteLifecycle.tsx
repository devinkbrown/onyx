...
const ROUTE_LIFECYCLE_SEEDS = [
  ...
  { path: '/download', id: 'download', label: 'Download', publicNavigation: true },
  { path: '/onyxos', id: 'onyxos', label: 'OnyxOS', publicNavigation: false },
  { path: '/status', id: 'status', label: 'Status', publicNavigation: false },
