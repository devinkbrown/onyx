...
/**
 * Leftover overlay URLs now serve the same Getting started how-tos. Neither
 * appears in the primary navigation, so each must still be operable from the
 * shared frame at 400% zoom.
 */
const routes = [
  { path: '/guides/', mainLabel: 'Onyx guides', heading: 'Getting started' },
  { path: '/community/', mainLabel: 'Onyx community', heading: 'Getting started' },
] as const;
